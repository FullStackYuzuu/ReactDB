        ...
        <AuthenticatedLayout
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-8000 
                    ...
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm: rounded-lg">
                        ...
                        dark:text-gray-100">
                            ...
                            text-gray-500 dark:text-gray-400">
                                ...
                                bg-gray-50 dark:bg-gray-700 dark:text-gray-480 
                                ...
                                <tbody>
                                    {projects.data.map((project) => (
                                        ...
                                        dark:bg-gray-800 dark:border-gray-700" key={project.id}>
                                            ...
                                            <td className="px-3 py-2">
                                                ...
                                                className="font-medium text-blue-600 dark:text-red-500
